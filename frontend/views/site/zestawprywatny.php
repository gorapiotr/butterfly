...
<div class="site-index">
    	...
    	<div  class="text-left">
        <h3>Prywatne zestawy słówek użytkownika: <?php echo Yii::$app->user->identity->imie.' '.Yii::$app->user->identity->nazwisko ?></h3>
        </div>
        <?php 
	...
	if (!yii::$app->user->isGuest && in_array(Yii::$app->user->identity->rola->nazwa,['Administrator','Redaktor','SuperRedaktor','Użytkownik']) && isset($uprawnienia))
	{ 
